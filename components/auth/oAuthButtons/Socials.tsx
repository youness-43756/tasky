...
export default function Socials() {
    ...
    return (
        <main className='flex gap-2 mb-3'>
            <Button variant={'superGhost'} size={'full'} className='space-x-2' onClick={() => clickHandler('github')}>
                <Github />
                <label className='cursor-pointer'>
                    GitHub
                </label>
            </Button>
            <Button variant={'superGhost'} size={'full'} className='space-x-2 text-slate-800' onClick={() => clickHandler('google')}>
